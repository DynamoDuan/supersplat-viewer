...
class OrbitController implements CameraController {
    ...
    constructor() {
        ...
        // Match Three.js OrbitControls dampingFactor = 0.05 (which means 95% retention)
        this.controller.rotateDamping = 0.95;
        this.controller.moveDamping = 0.95;
        this.controller.zoomDamping = 0.95;
    }
